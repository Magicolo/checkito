...
/// Like [`tuples!`] but passes three name tokens per arity to the callback:
/// `($m!(anyN_uniform, anyN_weighted, orN, c, ...))`.
///
/// This allows a single callback macro to generate both the uniform and
/// weighted `State::anyN_*` methods (and the corresponding `Generate` impls
/// in `any.rs`) without identifier concatenation.
macro_rules! tuples_any {
    ($m: ident) => {
        $m!(any0_uniform, any0_weighted, or0, 0);
        $m!(any1_uniform, any1_weighted, or1, 1, p0, T0, 0);
        $m!(any2_uniform, any2_weighted, or2, 2, p0, T0, 0, p1, T1, 1);
        $m!(any3_uniform, any3_weighted, or3, 3, p0, T0, 0, p1, T1, 1, p2, T2, 2);
        $m!(any4_uniform, any4_weighted, or4, 4, p0, T0, 0, p1, T1, 1, p2, T2, 2, p3, T3, 3);
        $m!(
            any5_uniform, any5_weighted, or5, 5,
            p0, T0, 0, p1, T1, 1, p2, T2, 2, p3, T3, 3, p4, T4, 4
        );
        $m!(
            any6_uniform, any6_weighted, or6, 6,
            p0, T0, 0, p1, T1, 1, p2, T2, 2, p3, T3, 3, p4, T4, 4, p5, T5, 5
        );
        $m!(
            any7_uniform, any7_weighted, or7, 7,
            p0, T0, 0, p1, T1, 1, p2, T2, 2, p3, T3, 3, p4, T4, 4, p5, T5, 5, p6, T6, 6
        );
        $m!(
            any8_uniform, any8_weighted, or8, 8,
            p0, T0, 0, p1, T1, 1, p2, T2, 2, p3, T3, 3, p4, T4, 4, p5, T5, 5, p6, T6, 6,
            p7, T7, 7
        );
        $m!(
            any9_uniform, any9_weighted, or9, 9,
            p0, T0, 0, p1, T1, 1, p2, T2, 2, p3, T3, 3, p4, T4, 4, p5, T5, 5, p6, T6, 6,
            p7, T7, 7, p8, T8, 8
        );
        $m!(
            any10_uniform, any10_weighted, or10, 10,
            p0, T0, 0, p1, T1, 1, p2, T2, 2, p3, T3, 3, p4, T4, 4, p5, T5, 5, p6, T6, 6,
            p7, T7, 7, p8, T8, 8, p9, T9, 9
        );
        $m!(
            any11_uniform, any11_weighted, or11, 11,
            p0, T0, 0, p1, T1, 1, p2, T2, 2, p3, T3, 3, p4, T4, 4, p5, T5, 5, p6, T6, 6,
            p7, T7, 7, p8, T8, 8, p9, T9, 9, p10, T10, 10
        );
        $m!(
            any12_uniform, any12_weighted, or12, 12,
            p0, T0, 0, p1, T1, 1, p2, T2, 2, p3, T3, 3, p4, T4, 4, p5, T5, 5, p6, T6, 6,
            p7, T7, 7, p8, T8, 8, p9, T9, 9, p10, T10, 10, p11, T11, 11
        );
        $m!(
            any13_uniform, any13_weighted, or13, 13,
            p0, T0, 0, p1, T1, 1, p2, T2, 2, p3, T3, 3, p4, T4, 4, p5, T5, 5, p6, T6, 6,
            p7, T7, 7, p8, T8, 8, p9, T9, 9, p10, T10, 10, p11, T11, 11, p12, T12, 12
        );
        $m!(
            any14_uniform, any14_weighted, or14, 14,
            p0, T0, 0, p1, T1, 1, p2, T2, 2, p3, T3, 3, p4, T4, 4, p5, T5, 5, p6, T6, 6,
            p7, T7, 7, p8, T8, 8, p9, T9, 9, p10, T10, 10, p11, T11, 11, p12, T12, 12,
            p13, T13, 13
        );
        $m!(
            any15_uniform, any15_weighted, or15, 15,
            p0, T0, 0, p1, T1, 1, p2, T2, 2, p3, T3, 3, p4, T4, 4, p5, T5, 5, p6, T6, 6,
            p7, T7, 7, p8, T8, 8, p9, T9, 9, p10, T10, 10, p11, T11, 11, p12, T12, 12,
            p13, T13, 13, p14, T14, 14
        );
        $m!(
            any16_uniform, any16_weighted, or16, 16,
            p0, T0, 0, p1, T1, 1, p2, T2, 2, p3, T3, 3, p4, T4, 4, p5, T5, 5, p6, T6, 6,
            p7, T7, 7, p8, T8, 8, p9, T9, 9, p10, T10, 10, p11, T11, 11, p12, T12, 12,
            p13, T13, 13, p14, T14, 14, p15, T15, 15
        );
    };
}

pub(crate) use tuples;
pub(crate) use tuples_any;
