...
pub mod char {
    ...
    impl Generate for Full<char> {
        ...
        const CARDINALITY: Option<u128> = Some(u128::wrapping_sub(char::MAX as _, 0 as char as _).wrapping_add(1));
...
macro_rules! integer {
    ($type: ident, $constant: ident) => {
        ...
        impl Generate for Full<$type> {
            ...
            const CARDINALITY: Option<u128> = Some(u128::wrapping_sub($type::MAX as _, $type::MIN as _).wrapping_add(1));
